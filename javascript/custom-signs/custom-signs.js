...
export function buildBirthdaySign(age) {
  const age_of_maturity = 50;
  return `Happy Birthday! What a ${age >= age_of_maturity ? 'mature' : 'young'} fellow you are.`;
}
...
export function costOf(sign, currency) {
  ...
  const cost = sign.length * price_per_letter + base_price;
